...
NMilitary = {
	...
	RELIABILTY_RECOVERY = 1.0,                     -- 1.0 = reliability translates 1:1 to recovery chance after battle .factor affecting how much equipment is returned "from the dead"
	...
	EQUIPMENT_COMBAT_LOSS_FACTOR = 1.0,	 		   -- % of equipment lost to strength ratio in combat, so some % is returned if below 1
